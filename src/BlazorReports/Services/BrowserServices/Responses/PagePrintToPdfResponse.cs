...
public sealed record PagePrintToPdfResponse(string Data, string Stream);
...
internal sealed partial class PagePrintToPdfResponseSerializationContext : JsonSerializerContext { }
